angular.module('tink.gis').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/other/mapTemplate.html',
    ...
    "<input id=locatiezoek class=\"zoekbalk typeahead\" sf-typeahead options=exampleOptionsNonEditable datasets=numbersDataset ng-model=selectedNumberNonEditable ng-show=\"mapctrl.ZoekenOpLocatie == true\" placeholder=\"Geef een X,Y / locatie of POI in.\" ng-keyup=\"$event.keyCode == 13 && mapctrl.zoekLocatie(mapctrl.zoekLoc)\">\n" +
