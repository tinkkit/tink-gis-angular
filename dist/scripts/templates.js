angular.module('tink.gis').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/other/layerTemplate.html',
    "<div class=layercontroller-checkbox>\n" +
    "<img style=\"width:30px; height:30px\" ng-if=\"lyrctrl.layer.theme.Type == 'esri' && lyrctrl.layer.legend.length == 1\" ng-src={{lyrctrl.layer.legend[0].fullurl}}>\n" +
    ...
    "<img style=\"width:30px; height:30px\" ng-src={{legend.fullurl}}><img><span> {{legend.label}}</span>\n" +
    "</div>\n" +
    "</div>"
  );
