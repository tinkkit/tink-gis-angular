angular.module('tink.gis').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/other/mapTemplate.html',
    ...
    "<svg class=\"icon icon-measure-shape\"><use xlink:href=#icon-measure-shape></use></svg><span class=name>\n" +
    "</span></button>\n" +
    "</div>\n" +
    "<div class=\"btn-group ll searchbtns\">\n" +
    "<button type=button class=btn ng-class=\"{active: mapctrl.ZoekenOpLocatie==true}\" ng-click=mapctrl.fnZoekenOpLocatie() tink-tooltip=\"Zoeken op locatie\" tink-tooltip-align=bottom prevent-default-map>\n" +
    "<svg class=\"icon icon-search-location\"><use xlink:href=#icon-search-location></use></svg>\n" +
    "</button>\n" +
    ...
    "<svg class=\"icon icon-search-layers\"><use xlink:href=#icon-search-layers></use></svg>\n" +
    "</button>\n" +
    "</div>\n" +
  ...
  $templateCache.put('templates/search/searchSelectedTemplate.html',
    ...
    "<svg class=\"icon icon-doordruk\"><use xlink:href=#icon-doordruk></use></svg>\n" +
    "</button>\n" +
