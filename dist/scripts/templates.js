angular.module('tink.gis').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/search/searchResultsTemplate.html',
    ...
    "<div class=flex-column ng-show=srchrsltsctrl.drawingObject>\n" +
    "<div class=\"col-xs-12 flex-grow-1 margin-top\">\n" +
    "Drawing:\n" +
    "<button class=btn-sm ng-click=srchrsltsctrl.deleteDrawing()>Delete</button>\n" +
    "<button class=btn-sm ng-click=srchrsltsctrl.zoom2Drawing()>Tonen</button>\n" +
    "<button class=btn-sm ng-click=srchrsltsctrl.bufferFromDrawing()>Buffer</button>\n" +
    "</div>\n" +
    "</div>\n" +
