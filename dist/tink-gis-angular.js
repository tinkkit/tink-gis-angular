        ...
        return {
            ...
            controller: ['$scope', '$rootScope', '$timeout', function ($scope, $rootScope, timeout) {
                ...
                ctrl.perPageChange = function () {
                    ...
                    timeout(function () {
                        $scope.tinkChange({
                            page: $scope.tinkCurrentPage, perPage: $scope.tinkItemsPerPage, next: function next() {
